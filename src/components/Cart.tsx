                ...
                >
                  ...
                  <div className="flex-1 overflow-hidden">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <button className="inline-flex h-8 w-8 items-center justify-center rounded-md bg-gray-900 text-sm font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300">
          ...
          <div className="sticky bottom-0 bg-gray-950 rounded-lg shadow-lg p-6 md:p-8 md:sticky md:top-4">
            <div className="grid gap-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="font-medium">$229.97</p>
              </div>
